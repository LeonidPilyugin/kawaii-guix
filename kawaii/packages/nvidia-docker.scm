(define-module (kawaii packages nvidia-docker) ;; adapt module name for your own use
...
(define-public libnvidia-container
  (package
    ...
    (source (origin
              ...
              (file-name (git-file-name name version))
              (patches (kawaii-patches "libnvidia-container.patch"))
              (sha256
               (base32
